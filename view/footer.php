    ...
    <div class="container">
            ...
            <div class="row mt-none-40">
                <div class="footer__widget col-lg-3 col-md-6 mt-40">
                    <div class="footer__logo mb-20">
                        <a href="index.html"><img src="layout/assets/img/logo/logo.svg" alt=""></a>
                    </div>
                    ...
                    <div class="apps-img mt-15 ul_li">
                        <div class="app mt-15">
                            <a href="#!"><img src="layout/assets/img/icon/google_play.png" alt=""></a>
                        </div>
                        <div class="app mt-15">
                            <a href="#!"><img src="layout/assets/img/icon/app_store.png" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="footer__widget col-lg-3 col-md-6 mt-40">
        ...
        <div class="footer__bottom ul_li_center">
            ...
            <div class="payment_method mt-15">
                <img src="layout/assets/img/bg/payment_method.png" alt="">
            </div>
        </div>
    </div>
</footer>
...
<!-- jquery include -->
<script src="layout/assets/js/jquery-3.5.1.min.js"></script>
<script src="layout/assets/js/bootstrap.bundle.min.js"></script>
<script src="layout/assets/js/slick.js"></script>
<script src="layout/assets/js/backToTop.js"></script>
<script src="layout/assets/js/uikit.min.js"></script>
<script src="layout/assets/js/resize-sensor.min.js"></script>
<script src="layout/assets/js/theia-sticky-sidebar.min.js"></script>
<script src="layout/assets/js/wow.min.js"></script>
<script src="layout/assets/js/jqueryui.js"></script>
<script src="layout/assets/js/touchspin.js"></script>
<script src="layout/assets/js/countdown.js"></script>
